...
/* package haskell-bug-macos11-can-not-load-cocoa-0.1.0.0 */
#ifndef VERSION_haskell_bug_macos11_can_not_load_cocoa
#define VERSION_haskell_bug_macos11_can_not_load_cocoa "0.1.0.0"
#endif /* VERSION_haskell_bug_macos11_can_not_load_cocoa */
#ifndef MIN_VERSION_haskell_bug_macos11_can_not_load_cocoa
#define MIN_VERSION_haskell_bug_macos11_can_not_load_cocoa(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_haskell_bug_macos11_can_not_load_cocoa */
...
#define CURRENT_COMPONENT_ID "haskell-bug-macos11-can-not-load-cocoa-0.1.0.0-5pe4fxIzxcIINpEmH0CUam-haskell-bug-macos11-can-not-load-cocoa"
